...
namespace OurResto
{
    public partial class FormSalarie : Form
    {
        ...
        private void FormSalarie_Load(object sender, EventArgs e)
        {
            ...
            Manager.ResizeImage(btUpdate, Properties.Resources.Edit_256x256, ContentAlignment.MiddleLeft);
        ...
        private void DGVSalarie_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (salarieBindingSource.Current is cda68_bd1DataSet.SalarieRow currentRow)
                {
                    ...
                    transactionBindingSource.DataSource = cda68_bd1DataSet.Transaction.Where(r => r.Matricule == currentRow.Matricule).ToList();
                    //transactionTableAdapter.FillBy(cda68_bd1DataSet.Transaction, currentRow.Matricule);
        ...
        private void BtCredit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int Id_TypePaiement = ((cda68_bd1DataSet.TypePaiementRow)((DataRowView)typePaiementBindingSource.Current).Row).Id_TypePaiement;
